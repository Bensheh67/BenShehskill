...
description: |
  ...
  触发方式：/bss-ai-check、/AI检测、「帮我看看有没有 AI 味」「检测一下 AI 特征」
  ...
  Trigger: /bss-ai-check, "check for AI writing", "does this sound like AI"
---
...
- 用户的文案本身选题有问题 → 「AI 味不是你最大的问题。选题本身需要重新想。试试 `/bss-content`。」
