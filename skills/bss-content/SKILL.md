...
description: |
  ...
  触发方式：/bss-content、/内容诊断、「这个内容怎么做」「帮我看看这个文案」
  Content creation diagnosis. After topic passes, diagnose how to turn it into good content.
  Trigger: /bss-content, "how should I create this content", "review my copy"
---
...
> 这次诊断的内容卡点和优化方向，输入 `/bss-save` 存档。下次写新内容前 `/bss-restore` 看一眼，避免再踩同样的坑。
