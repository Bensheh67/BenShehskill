...
description: |
  ...
  触发方式：/bss-benchmark、/对标、「帮我找对标」「我该模仿谁」
  Benchmark analysis using dontbesilent's five-filter method.
  Trigger: /bss-benchmark, "find me a benchmark", "who should I copy"
---
...
> 这次找到的对标和模仿颗粒度，输入 `/bss-save` 存档。下次想加新对标或者复盘有没有真的模仿到位，`/bss-restore` 接着上次。
