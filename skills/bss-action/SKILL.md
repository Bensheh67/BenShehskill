...
description: |
  ...
  触发方式：/bss-action、/action、「我知道该怎么做但就是不做」「为什么我总是拖延」
  Execution block diagnosis using Adlerian psychology framework.
  Trigger: /bss-action, "I know what to do but can't do it", "why do I procrastinate"
---
...
> 你今天发现的反向动力和真实目的，输入 `/bss-save` 存档。下次再卡住，`/bss-restore` 把它拉出来对照——很多时候你不是又卡了，是同一个反向动力换了个壳。
